 ...
 */
	    ...
	    defined(CONFIG_TARGET_LS1046ACCX) || \
...
#if defined(CONFIG_TARGET_LS1046ARDB) || defined(CONFIG_TARGET_LS1043ARDB) || defined(CONFIG_TARGET_LS1046ACCX)
	rcw_tmp = in_be32(&gur->rcwsr[15]);
	switch ((rcw_tmp & HWA_CGA_M2_CLK_SEL) >> HWA_CGA_M2_CLK_SHIFT) {
	case 1:
		sys_info->freq_cga_m2 = freq_c_pll[1];
		break;
#if defined(CONFIG_TARGET_LS1046ARDB) || defined(CONFIG_TARGET_LS1046ACCX)
	case 2:
